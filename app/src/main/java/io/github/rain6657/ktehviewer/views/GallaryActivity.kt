...
class GallaryActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vdb = ActivityGallaryBinding.inflate(layoutInflater)
        ...
        fullscreenContent = vdb.fullscreenContent
        fullscreenContent.setOnClickListener { toggle() }

        fullscreenContentControls = vdb.fullscreenContentControls

        // Upon interacting with UI controls, delay any scheduled hide()
        // operations to prevent the jarring behavior of controls going away
        // while interacting with the UI.
        vdb.dummyButton.setOnTouchListener(delayHideTouchListener)
    }
